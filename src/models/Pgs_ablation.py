...
class PGS(nn.Module):
    ...
    def __fw_unsupervised_layerwise_1(self, X):  # only_feature space aug  layerwise2 asli
        ...
        supervised_outputs = aug_output9_teach
        unsupervised_outputs = output9_stud
        return supervised_outputs, unsupervised_outputs

    def __fw_unsupervised_layerwise_2(self, X):  # only_feature space aug  layerwise2 asli
        ...
        supervised_outputs = aug_output8_teach
