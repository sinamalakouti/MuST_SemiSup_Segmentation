...
def avg_all(root, root2020):
    ...
    WT = (np.array(WT2019) * 50 + np.array(WT2020) * 36) / (36 + 50)
    ET = (np.array(ET2019) * 50 + np.array(ET2020) * 36) / (36 + 50)
    TC = (np.array(TC2019) * 50 + np.array(TC2020) * 36) / (36 + 50)
...
year2020 = 'test2020'
root2019 = '/projects/sina/W-Net/PGS_result/Brats/CVPR2022/semi_pgs_CE_all2018/{}_ratio_{}/seed_{}/result_images/{}_new_results_iter'.format(
    mode,
    ratio, seed, year2019)

root2020 = '/projects/sina/W-Net/PGS_result/Brats/CVPR2022/semi_pgs_CE_all2018/{}_ratio_{}/seed_{}/result_images/{}_new_results_iter'.format(
    mode,
    ratio, seed, year2020)

WT1, ET1, TC1 = avg_all(root2019, root2020)
...
WT2, ET2, TC2 = avg_all(root2019, root2020)
...
WT3, ET3, TC3 = avg_all(root2019, root2020)
